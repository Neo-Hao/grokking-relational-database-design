...
CREATE TABLE IF NOT EXISTS review (
  ...
  CONSTRAINT fk_review_user1 FOREIGN KEY (email) REFERENCES user (email) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_review_product1 FOREIGN KEY (code) REFERENCES product (code) ON DELETE CASCADE ON UPDATE CASCADE
);
